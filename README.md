...
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software. | Gómez Flores, Daniela Araceli <br />TB1: <br />Colaboré en la creación de user stories, realicé entrevistas y participé en la elaboración del Product Backlog. Me encargué del Bounded Context: Event, lo que me permitió profundizar en el diseño de software orientado al dominio. <br /><br />Curipaco Huayllani, Neil <br />TB1:<br />Describí el startup profile, elaboré los Lean UX Hypothesis Statements y el Canvas, y colaboré en la creación de user stories, el Product Backlog y el EventStorming. Me responsabilicé del Bounded Context: Profile, lo que me exigió investigar y aplicar técnicas de modelado de dominio. <br /><br />Diaz Fiestas, Jorge Luis <br />TB1:<br />Elaboré el Empathy Mapping y el Ubiquitous Language, y colaboré en la sesión de EventStorming. Me encargué del Bounded Context: Announcement, lo que me llevó a aprender sobre la identificación de contextos delimitados. <br /><br />Medina Cruzado, Raúl Adrian <br />TB1: <br />Realizó análisis competitivo, estrategias frente a competidores e Impact Mapping. Se encargó del Bounded Context: Notification. <br /><br />Vaszquez Villalobos, Elverth Jair <br />TB1: <br />Colaboró en entrevistas, realizó Context Mapping. Se encargó del Bounded Context: Chat. | TB1: <br />El equipo demostró su capacidad para investigar, aplicar y documentar técnicas y herramientas modernas de ingeniería de software, tales como Domain-Driven Design, Lean UX, EventStorming y gestión ágil de requerimientos, actualizando continuamente sus conocimientos para el desarrollo del proyecto. |
| Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software. | Gómez Flores, Daniela Araceli:<br />TB1:<br />Participé activamente en las revisiones de mi bounded context (Event), incorporando feedback y mejorando los artefactos en iteraciones sucesivas. Reconozco que la mejora continua es esencial para el desarrollo de software de calidad.  <br /><br />Curipaco Huayllani, Neil:<br />TB1:  <br />Como Team Leader, coordiné las actividades de aprendizaje colaborativo, asegurándome de que integráramos nuevas prácticas de DDD y Lean UX en cada entrega. Comprendo que el liderazgo técnico requiere un aprendizaje constante. <br /><br />Diaz Fiestas, Jorge Luis: <br />TB1:<br />Investigué y apliqué técnicas de Ubiquitous Language y Empathy Mapping, ajustando mi enfoque tras las primeras retroalimentaciones. Valoro la capacidad de adaptarse y aprender de los errores.<br /> <br />Medina Cruzado, Raúl Adrian: <br />TB1:<br />Evolucioné mi comprensión del análisis competitivo y el Impact Mapping, refinando mi trabajo en base a la investigación continua. Reconozco que la competitividad exige estar siempre actualizado. <br /><br />Vaszquez Villalobos, Elverth Jair: <br />TB1:<br />Aprendí y apliqué técnicas de Context Mapping y realización de entrevistas, demostrando mejora continua en la calidad de mis contribuciones. Entiendo que el aprendizaje autónomo es clave en la ingeniería de software. | TB1: <br />El equipo internalizó la importancia del aprendizaje continuo y la adaptabilidad en el ámbito de la ingeniería de software, reconociendo que el desarrollo profesional exige una actualización constante tanto en herramientas como en metodologías, lo cual se reflejó en la evolución y refinamiento del proyecto a lo largo del ciclo. |
