...
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software. | **Gómez Flores, Daniela Araceli** <br />**TB1:** <br />Colaboré en la creación de user stories, realicé entrevistas y participé en la elaboración del Product Backlog. Me encargué del Bounded Context: Event, lo que me permitió profundizar en el diseño de software orientado al dominio. <br /><br />**TP1:** <br />Implementé la sección "About" y FAQ de la landing page utilizando HTML5, CSS3 y JavaScript, aplicando principios de diseño responsive. Desarrollé la creación básica de eventos (US26) con Spring Boot, aprendiendo sobre el manejo de fechas y validaciones en APIs REST.<br />**Curipaco Huayllani, Neil** <br />**TB1:**<br />Describí el startup profile, elaboré los Lean UX Hypothesis Statements y el Canvas, y colaboré en la creación de user stories, el Product Backlog y el EventStorming. Me responsabilicé del Bounded Context: Profile, lo que me exigió investigar y aplicar técnicas de modelado de dominio. <br /><br />**TP1:** <br />Desarrollé la sección de links profesionales del equipo y el sistema de gestión de perfiles de usuario, implementando APIs REST con Spring Boot y JWT para autenticación. Aprendí sobre seguridad en APIs y manejo de tokens de acceso.<br /><br />**Diaz Fiestas, Jorge Luis <br />TB1:**<br />Elaboré el Empathy Mapping y el Ubiquitous Language, y colaboré en la sesión de EventStorming. Me encargué del Bounded Context: Announcement, lo que me llevó a aprender sobre la identificación de contextos delimitados. <br /><br /><br />**TP1:** <br />Implementé el sistema completo de anuncios con Spring Boot, aprendiendo sobre relaciones JPA y manejo de archivos multimedia. Además, diseñé los wireframes, wireflow diagrams y mockups de la aplicación móvil usando Figma.<br /><br />**Medina Cruzado, Raúl Adrian <br />TB1**: <br />Realizó análisis competitivo, estrategias frente a competidores e Impact Mapping. Se encargó del Bounded Context: Notification. <br /><br />**TP1:** <br />Implementé la visualización de imágenes en anuncios  y el sistema de notificaciones push con Firebase Cloud Messaging. Diseñé los user flow diagrams de la aplicación.<br />**Vaszquez Villalobos, Elverth Jair <br />TB1:** <br />Colaboró en entrevistas, realizó Context Mapping. Se encargó del Bounded Context: Chat.<br /><br />**TP1:** <br />Implementé el sistema completo de chats. Aprendí sobre comunicación bidireccional y manejo de sesiones. Desarrollé el prototyping interactivo de la aplicación móvil. | **TB1:** <br />El equipo demostró su capacidad para investigar, aplicar y documentar técnicas y herramientas modernas de ingeniería de software, tales como Domain-Driven Design, Lean UX, EventStorming y gestión ágil de requerimientos, actualizando continuamente sus conocimientos para el desarrollo del proyecto.<br /><br />**TP1:** El equipo consolidó sus conocimientos en desarrollo full-stack, integrando frontend web con backend Spring Boot y aplicación móvil nativa, demostrando capacidad para aprender y aplicar múltiples tecnologías de manera coordinada. |
